...
pg = st.navigation([home_page, setup_page, variables_page, basic_output_page, basic_math_page, user_input_page, planning_design_page, conditionals_page, functions_page, loops_page])
pg.run()